...
Let's make a simple tool to make a publication quality figure with the grahical derivation of the Andover result. 
...
We chose `r uvnet_files[dset]`. And then find all the spectra from the `r day`th day in `r year`.
